  ...
  return (
    <div className="pointer-events-auto absolute inset-0 z-40 overflow-y-auto bg-black/55 backdrop-blur-sm">
      <div className="flex min-h-full items-start justify-center px-4 pb-6 pt-[max(5.5rem,calc(env(safe-area-inset-top)+4.75rem))] sm:items-center sm:py-6">
        <section className="w-full max-w-xl rounded-[2rem] border border-cyan-200/30 bg-[#0c1824]/95 p-5 text-[#e8f4f8] shadow-2xl sm:p-7">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
              ...
              <div className="mt-3 grid max-h-48 gap-1 overflow-y-auto pr-1">
...
export function ShoreFishingResult() {
  ...
  return (
    <div className="pointer-events-auto absolute inset-0 z-40 overflow-y-auto bg-black/60 backdrop-blur-sm">
      <div className="flex min-h-full items-start justify-center px-4 pb-6 pt-[max(5.5rem,calc(env(safe-area-inset-top)+4.75rem))] sm:items-center sm:py-6">
        <section className="w-full max-w-md rounded-[2rem] border border-cyan-200/30 bg-[#0c1824]/95 p-6 text-[#e8f4f8] shadow-2xl">
          <p className="text-center text-[0.65rem] font-semibold uppercase tracking-[0.3em] text-cyan-200/70">
            {t.resultTitle}
          </p>
          <p className="mt-2 text-center font-[family-name:Georgia,Times_New_Roman,serif] text-3xl">
            {ratingId ? ratingLabel(ratingId) : '—'}
          </p>
          <p className="mt-3 text-center font-mono text-4xl font-black text-amber-100">{score}</p>
          ...
          <div className="mt-5 rounded-2xl border border-white/10 bg-black/25 p-4">
            ...
            {tallies.size === 0 ? (
              ...
              <div className="mt-3 grid max-h-48 gap-1.5 overflow-y-auto">
