...
export function TargetHUD() {
  ...
  return (
    <aside
      className={`pointer-events-none absolute top-16 right-5 z-30 hidden max-h-[calc(100dvh-5rem)] overflow-y-auto overscroll-contain rounded-2xl border p-3 text-white shadow-2xl backdrop-blur-md lg:block w-auto ${
        isAnswerReveal
