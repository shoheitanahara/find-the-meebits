...
export function MiniMap() {
  ...
  return (
    <aside
      className={`pointer-events-none absolute bottom-5 left-5 z-30 rounded-3xl border p-4 text-white shadow-2xl backdrop-blur-md ${
        isAnswerReveal
    ...
    >
      ...
      <div className="relative mt-3 h-36 w-36 overflow-hidden rounded-2xl border border-neutral-600 bg-neutral-800">
