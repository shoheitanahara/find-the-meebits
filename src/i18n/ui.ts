...
const en: UiMessages = {
  ...
  tipsMuseumLead: 'A few things that help in the museum.',
  tipsClubLead: 'A few things that help in After Hours.',
  tipsControls: 'PC: Press E to talk · Mobile: Tap Talk when nearby',
  gotIt: 'Got it',
  ...
  tipRedMuseum: 'Walk up to a Meebit. A red dot above them means you can talk.',
  tipRedClub: 'Walk up to a Meebit on the floor. A red dot above them means you can talk.',
  tipNpcTitle: 'Friendly NPCs',
  tipNpcMuseum: 'Everyone in the museum is on your team. Chat often — someone may surprise you with a hint.',
  tipNpcClubTitle: 'Club crowd',
  tipNpcClub:
    'Everyone in After Hours is fair game to chat with. Someone near the bar, DJ booth, or VIP lounge might drop a hint.',
  tipTargetTitle: 'Find your target',
  tipTargetMuseum: 'Match the target shown in the corner. Wrong Meebit? Keep searching and keep talking.',
  tipTargetClub: 'Match the target in the corner. Wrong face? Keep moving through the lights and keep talking.',
  langEn: 'EN',
  langJa: '日本語',
