...
const en: EightStreetCopy = {
  ...
  wallRulesTitle: 'Information',
  wallRules: [
    '1. Remember the usual people.',
    '2. If you find someone unfamiliar, turn back immediately.',
    '3. If only the usual people are there, do not turn back.',
    '4. Reach the house on 8th Street.',
  ],
...
const ja: EightStreetCopy = {
  ...
  wallRules: [
    '1. いつもの人たちをよく覚えること',
    '2. 見慣れない人がいたら、すぐに引き返すこと',
    '3. いつもの人たちしかいなければ、引き返さないこと',
    '4. 8番ストリートの家にたどり着くこと',
  ],
