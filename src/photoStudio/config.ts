...
export const PHOTO_STUDIO = {
  ...
  poses: [
    ...
    { id: 'handOnHip', label: { en: 'Hand on hip', ja: '腰に手' } },
    { id: 'crossArms', label: { en: 'Crossed arms', ja: '腕組み' } },
    { id: 'wave', label: { en: 'Wave', ja: '手を振る' } },
    { id: 'think', label: { en: 'Think', ja: '考える' } },
    { id: 'cheer', label: { en: 'Cheer', ja: 'ガッツポーズ' } },
    { id: 'power', label: { en: 'Power', ja: 'パワー' } },
