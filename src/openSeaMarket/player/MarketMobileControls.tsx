...
import { advanceMarketDialogue, tryInteractWithListedMeebit } from '../dialogue/interactWithListing'

const JOYSTICK_RADIUS = 44
const BASE_SIZE = 112
const KNOB_SIZE = 44

export function MarketMobileControls() {
...
function MarketTalkButton() {
  ...
  const t = ui()
  const isMarketDialogue =
    isDialogueOpen && typeof activeNpcId === 'string' && activeNpcId.startsWith('opensea-')
  ...
  return (
    ...
    >
      <div
        ...
        style={{ width: BASE_SIZE, height: BASE_SIZE, transform: 'translate(-50%, -50%)' }}
      />
      <div
